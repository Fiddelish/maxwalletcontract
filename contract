...
contract Token is ERC20, Ownable {
    ...
    address payable public MAGICWallet = payable
    address payable public MarketingWallet = payable
    address payable public BurnAdress = payable
